 ...
 * 
 * <p><a href="http://templelibrary.googlecode.com/svn/trunk/modules/ui/examples/temple/facebook/api/PhotosExample.html" target="_blank">View this example</a></p>
 * 
...
package
{
	...
	public class PhotosExample extends DocumentClassExample
	{
		...
		private function handleClick(event:MouseEvent):void
		{
			...
			{
				_facebook.photos.getProfilePhotos(this.onPhotos);
			}
			else
			{
				_facebook.photos.getPhotos(this.onPhotos, FacebookConstant.ME, 0, 40);
			}
		}
